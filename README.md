...
- [ ] Mention two parts of Express that you learned about this week.
    2 parts of express are Routing and Middleware.
- [ ] Describe Middleware?
    Express Middleware adds features to Express. We can think of middleware as array of functions that get executed in the order they are introduced into the server code. Custom middleware are functions we write to perform certain tasks.
- [ ] Describe a Resource?
    A resource is an object with a type, associated data, relationships to other resources, and a set of methods that operate on it.
- [ ] What can the API return to help clients know if a request was successful?
    It can return a status code.
- [ ] How can we partition our application into sub-applications?
    We can break it into different routes.
